...
{/*                 
                ...
                <div className='w-full mt-4'>
                    <label htmlFor="phone" className='font-medium text-gray-500 '>Phone Number</label>
                ...
                <button type='submit' className='bg-indigo-500 text-white px-4 py-2 rounded mt-6 hover:bg-indigo-600 transition'>Register</button>
            </div>
            </form>
