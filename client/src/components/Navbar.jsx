...
const BookIcon = () => (
  ...
  >
    <path
      ...
      strokeWidth="2"
      d="M5 14v4a1 1 0 0 1-1h12a1 1 0 0 1 1v13H7a2 2 0 0 2-2Zm0 0a2 2 0 0 2 2h12M9 14m7 0v4"
    />
  </svg>
);
    ...
    >
      ...
      <div className="flex items-center gap-3 md:hidden">
        ...
        <img
          ...
          src={assets.menuIcon}
          alt="menu"
          className={`${isScrolled && "invert opacity-80"} h-4 `}
        />
      </div>
      ...
      >
       ...
       {user && <button className="border px-4 py-1 text-sm font-light rounded-full cursor-pointer transition-all" onClick={()=> isOwner ? navigate ('/owner') : setShowHotelReg(true)}>
        ...
        {/* if user is login then show dashboard */}
       ...
       {!user && <button
        ...
        >
         ...
         {/* user not login so we have to show login button */}
      </div>
    </nav>
  );
};
