...
{/* 
              ...
              {booking.isPaid && (
                ...
                {!booking.isPaid && (
                <button onClick={()=>handelPayment(booking._id)} className="px-4 py-1.5 mt-4 text-xs border border-gray-400 rounded-full hover:bg-gray-50 transition-all cursor-pointer">
                  Pay Now
                </button>
              )}
