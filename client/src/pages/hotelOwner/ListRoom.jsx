...
const toggleAvailability = async (roomId) => {
  ...
  if(data.success){
    ...
    fetchRooms(); // Refresh the room list to reflect the changes
  }else{
    toast.error(data.message);
  }
}
  ...
  return (
    <div>
      <Title
        ...
        font="outfit"
        title="List of Rooms"
        subTitle="Here you can see all the rooms you have added to your hotel. You can edit or delete any room as needed."
      />
      <p className="text-gray-700 mt-8">Total Rooms: {rooms.length}</p>
